...
package provide testbench_rom_xmdf 1.0
...
# is <core_name>_xmdf
namespace eval ::testbench_rom_xmdf {
...
# ::testbench_rom_xmdf::xmdfInit

# Function called by client to fill in all the xmdf* data variables
# based on the current settings of the parameters
proc ::testbench_rom_xmdf::xmdfApplyParams { instance } {
...
utilities_xmdf::xmdfSetData $instance FileSet $fcount relative_path testbench_rom.mif
utilities_xmdf::xmdfSetData $instance FileSet $fcount type AnyView
incr fcount

utilities_xmdf::xmdfSetData $instance FileSet $fcount relative_path testbench_rom.ngc
utilities_xmdf::xmdfSetData $instance FileSet $fcount type ngc
incr fcount

utilities_xmdf::xmdfSetData $instance FileSet $fcount relative_path testbench_rom.sym
utilities_xmdf::xmdfSetData $instance FileSet $fcount type symbol
incr fcount

utilities_xmdf::xmdfSetData $instance FileSet $fcount relative_path testbench_rom.v
...
utilities_xmdf::xmdfSetData $instance FileSet $fcount relative_path testbench_rom_xmdf.tcl
utilities_xmdf::xmdfSetData $instance FileSet $fcount type AnyView
incr fcount

utilities_xmdf::xmdfSetData $instance FileSet $fcount associated_module testbench_rom
incr fcount
